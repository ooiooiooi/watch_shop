...
export function GoldButton({ children, variant = "filled", fullWidth, className = "", ...props }: GoldButtonProps) {
  const base = "inline-flex items-center justify-center px-8 py-4 tracking-[0.2em] uppercase text-xs transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap shrink-0";
  const variants = {
